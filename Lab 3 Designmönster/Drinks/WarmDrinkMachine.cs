...
using Lab_3_Designmönster.Drinks.Cappuccino;
using Lab_3_Designmönster.Drinks.Chocolate;
using Lab_3_Designmönster.Drinks.Coffee;
using Lab_3_Designmönster.Drinks.Water;
...
namespace Lab_3_Designmönster.Drinks
{
    ...
    public class WarmDrinkMachine
    {
        ...
        public WarmDrinkMachine()
        {
            ...
            RegisterFactory<CappuccinoFactory>("Cappuccino"); // Registrerar fabriken för kaffe
